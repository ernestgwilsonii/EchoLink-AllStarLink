...
$passwdf1 = "/srv/http/supermon/edit/.htaccess";
$passwdf2 = "/srv/http/supermon/edit/.htpasswd";
$SUBMITTER = "submit";
...
<input type="button" class="<?php echo $SUBMITTER; ?>" value="Control" id="controlpanel">
<input style="margin-bottom:5px;" type="button" class="submit" value="Favorites" id="favoritespanel">
<input style="margin-bottom:5px;" type="button" class="submit" value="Group Favs" id="grpfavoritespanel">
...
<input style="margin-top:5px;" type="button" class="<?php echo $SUBMITTER ?>" value="Configuration Editor" OnClick="OpenConfigEditor()">
...
<input type="button" class="submit" value="SW Update?" id="openupdate">
<input style="margin-bottom:1px;" type="button" class="submit" value="Sync Grp Favs" id="syncgrpfav">
<?php } ?>
<br>
...
<input style="margin-top:1px;" type="button" class="<?php echo $SUBMITTER ?>" value="GPIO" id="openpigpio">
